...
<!-- <div class="container">
  ...
  <!-- Hero Section Begin -->
  <section class="hero" style="margin-top: -80px; background-color: #0b0c2a;">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="popular__product">
                        ...
                        <div class="row">
                            @foreach($adventureshows as $shows)
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg" data-setbg="{{asset('assets/img/'.$show->image.'')}}">
                                            <!-- <div class="ep">18 / 18</div>
